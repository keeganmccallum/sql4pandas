...
KEYWORDS_COMMON = {
    'SELECT': tokens.Keyword.SELECT,
    'INSERT': tokens.Keyword.INSERT,
    'DELETE': tokens.Keyword.DELETE,
    'UPDATE': tokens.Keyword.UPDATE,
    'REPLACE': tokens.Keyword.REPLACE,
    'MERGE': tokens.Keyword.MERGE,
    'DROP': tokens.Keyword.DROP,
    'CREATE': tokens.Keyword.CREATE,
    'ALTER': tokens.Keyword.ALTER,

    'WHERE': tokens.Keyword.WHERE,
    'FROM': tokens.Keyword.FROM,
    ...
    'ORDER': tokens.Keyword.ORDER,
    'LEFT': tokens.Keyword,
    'OUTER': tokens.Keyword,
    'FULL': tokens.Keyword,

    'IF': tokens.Keyword,
    'END': tokens.Keyword.END,
    'THEN': tokens.Keyword.THEN,
    'LOOP': tokens.Keyword,
    'AS': tokens.Keyword,
    'ELSE': tokens.Keyword,
    'FOR': tokens.Keyword,
